...
One day, while casually browsing the internet, I came across [yuanji](https://blog.yuanji.dev)'s personal blog. (I only realized while writing this post that the blog's interface has completely changed 🤣—personally, I preferred the old design.) I was immediately drawn to that blog-sharing vibe. After reading many of the author's posts, I finally decided to give it a real try and build my own blog using the static site generator [Hugo](https://gohugo.io/).
